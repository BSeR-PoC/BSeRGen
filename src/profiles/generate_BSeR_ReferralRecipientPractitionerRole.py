...
def generate_BSeR_ReferralRecipientPractitionerRole(practitioner_id: str = None,
    ...
    practitioner_role["meta"]["profile"] = [ "http://hl7.org/fhir/us/bser/StructureDefinition/BSeR-ReferralRecipientPractitionerRole" ]
